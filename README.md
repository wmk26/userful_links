...
[Juven Xu](http://www.juvenxu.com/) | 阿里巴巴，Java，maven
[闲思录](http://dbanotes.net/) | 冯大辉，原支付宝技术专家，先丁香园CTO
[温国兵的随想录](http://dbarobin.com/archives/) | 不错的网站，有不少相同的爱好
[Scott Young](http://www.scotthyoung.com/blog/articles/) | 一年时间学完MIT 4年CS课程，个人博客比较赏心悦目，学习之
[灵魂机器](http://cn.soulmachine.me/) | 武汉大学计算机本科，工作三年之后清华读硕士，准备去北美求职
[清华刘知远](http://nlp.csai.tsinghua.edu.cn/~lzy/) | 
[《博士五年总结》及我其它过去的博客文章](http://zhuanlan.zhihu.com/p/20606385) | 
[刘一佳个人网站](http://yjliu.net/) | 哈工大博士
[小土刀](http://wdxtub.com/) | CMU的硕士？一些课程笔记还可以
[龙哥盟](http://flygon.net/) | 
[hekaiming](http://kaiminghe.com/) | 图像领域大牛，两次CVPR最佳paper
[jasonfreak](http://www.cnblogs.com/jasonfreak/) | 不错的博客，实践性强
[读立写生 陈素封](http://www.cnfeat.com/) | 
...
[DMLC for Scalable and Reliable Machine Learning](http://dmlc.ml/) | 
...
[【(Python)人人都能写LSTM-RNN(实例教程)】《Anyone Can Learn To Code an LSTM-RNN in Python》](http://iamtrask.github.io/2015/11/15/anyone-can-code-lstm/) | 
[模型选择的一些基本思想和方法](http://cos.name/2015/08/some-basic-ideas-and-methods-of-model-selection/) | 
[Deep Learning Tutorial](http://ufldl.stanford.edu/tutorial/) | ufldl出了新的教程，感觉比之前的好很多。从基础讲起，系统清晰。链接是 Unsupervised Feature Learning and Deep Learning Tutorial我最近在学习，并做了一些笔记和编程作业。欢迎参考 http://blog.csdn.net/lingerlanlan感觉这个教程特别适合初学者。
[Modern Methods for Sentiment Analysis](https://districtdatalabs.silvrback.com/modern-methods-for-sentiment-analysis) | 
[End-to-End Deep Learning Tutorial (0.0392)](https://www.kaggle.com/c/second-annual-data-science-bowl/forums/t/18079/end-to-end-deep-learning-tutorial-0-0392/102412) | 
...
[牛津大学的机器学习课程](https://www.cs.ox.ac.uk/people/nando.defreitas/machinelearning/) | 有video和slides
...
[CSE 255: Dahta Mining and Predictive Analytics](http://cseweb.ucsd.edu/classes/fa15/cse255-a/) | 在推荐系统做出新颖工作的Julian McAuley研究生课程《数据挖掘和预测分析》，无需机器学习背景，但需要优化和线性代数基础，所有代码示例都是Python。第一部分是机器学习算法和数据挖掘方法：分类、回归和降维，第二部分是应用：推荐系统、在线广告、网络分析、文本挖掘、时序分析
[【投稿】一位算法师工程师的Spark机器学习笔记：构建一个简单的推荐系统](http://www.yidianzixun.com/home?page=article&id=0CbmOPAR&up=0) | 
...
[Explained Visually](http://setosa.io/ev/) | 【机器学习】这是一个通过动画、可视化方法形象介绍机器学习的网站：http://t.cn/R7FWWkk 包括最小二乘、主元分析、图像核函数、特征向量特征值、Pi、Sine和Cosine函数、马尔科夫链等
...
[Python爬虫技术:(JavaScript渲染)动态页面抓取超级指南](http://datartisan.com/article/detail/95.html) | 
...
[看看豆(原看Kindle)-免费电子书分享下载](http://kankandou.com/) | 
...
[晒晒IQ网——让你越玩越聪明](https://www.33iq.com/) | 
